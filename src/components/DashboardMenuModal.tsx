...
const DashboardMenuModal: FunctionComponent<IProps> = (props: IProps) => {
            ...
            <div className="bg-[#fff] w-[100%] h-[100%] p-5 rounded-lg flex flex-col items-center relative">
                ...
                <div>
                    <div className='flex items-center gap-5 mt-[2rem] text-[#000000af] hover:text-[#2cb1bc] cursor-pointer transition-[0.3s]'>
                        <GoCpu className="text-[22px]" />
                        Devices
                    </div>
                    <div className='flex gap-5 mt-[2rem] text-[#333] text-[#000000af] cursor-pointer transition-[0.3s]'>
                        <TfiDashboard className="text-[22px]" />
                        Dashboard
                    </div>
                    <div className='flex gap-5 items-center mt-[2rem] text-[#000000af] hover:text-[#2cb1bc] cursor-pointer transition-[0.3s]'>
                        <IoDocumentTextOutline className="text-[22px]" />
                        Document
                    </div>
                </div>
            </div>
